...
async function POST(req, res) {
    ...
    const existingCategory = leagueDataFilter.flatMap((item)=>item.queueDetails.filter((item2)=>item2.matchDay === newPushDate.matchDay));
...
var __webpack_exports__ = __webpack_require__.X(0, [212,632,335,63], () => (__webpack_exec__(89276)));
