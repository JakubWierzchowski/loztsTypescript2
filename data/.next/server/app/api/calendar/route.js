...
async function POST(req, res) {
    const filePath = (0,buildExtractPath/* buildPath */.L)("calendarDate.json");
    const calendar = (0,buildExtractPath/* extractPath */.v)(filePath);
    const myDate = moment_default()().format("YYYY-MM-DD HH:mm:ss");
    ...
    const playerExistsInTournament = calendar.some((item)=>item.details.some((item2)=>item2.link === newPlayer.tournament && item2.players && item2.players.find((existingPlayer)=>existingPlayer.player === newPlayer.player)));
...
var __webpack_exports__ = __webpack_require__.X(0, [212,632,335,63,434], () => (__webpack_exec__(6159)));
