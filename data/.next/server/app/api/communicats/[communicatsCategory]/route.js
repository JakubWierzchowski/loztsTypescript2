...
async function DELETE(req, res) {
    ...
    if (index !== -1) {
        const filePathToDelete = external_path_default().join(process.cwd(), "/public/downloadFiles/Sezon23-24/", deletedPlayer.fileName);
        external_fs_default().unlinkSync(filePathToDelete);
