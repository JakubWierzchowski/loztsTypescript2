...
import { Button, Modal, Span } from '@/ui/index';
      ...
      <Modal isOpen={isOpen} handleClose={handleClose}>
        <section className={styles.wrapper}>
          {data?.length === 0 ? (
            ...
            data?.map((item, index) => (
              <div key={item.fileName} className={styles.gridItems}>
                <Link
