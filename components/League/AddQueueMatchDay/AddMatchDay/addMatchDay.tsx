...
import { AddLeagueMatchdayProps, FormValuesDataMatch } from '@/types/leagues/league.types';
import { Button, TextForm } from '@/ui';
import useHTTPrequest from '@/utils/hooks/httpRequest/httpRequest';

export const AddLeagueMatchday: FC<AddLeagueMatchdayProps> = ({ leaguePath, fetchData }) => {
  ...
  return (
    ...
    >
      <TextForm
        ...
        placeholder={'np. 1 kolejka 15.10.2023 r.'}
        register={register}
        errors={errors}
      />
